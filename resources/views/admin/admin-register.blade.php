...
<div class="row reg-form justify-content-center">
    <div class="col-6 form-section text-center">
        <h2 class="bold-purple mb-5">Register as User</h2>
        @if(Session::has('success'))
            ...
            @endif
        <div class="row">
            <form action="{{ route('show-admin-login-form') }}" method="post">
            {{-- <form action="{{ route('show-admin-login-form') }}" method="post"> --}}
                @csrf
                <div class="col mb-3">
                ...
                <input type="hidden" name="usertype" id="usertype" value="1" class="form-control" />
