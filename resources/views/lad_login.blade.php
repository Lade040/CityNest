        ...
        <div class=" row login justify-content-center">
            ...
            <div class="col-5 form-section">
                ...
                <div class="row login-input">
                    <form action="{{ route('lad_home') }}" method="post">
                    <div class="col">
                        <input type="text" name="email" id="name" class="form-control mb-3" placeholder="Email">

                        <input type="password" name="password" id="email" class="form-control mb-3" placeholder="Password">
